...
def collect_prob(data_loader, model, dataname):
...
def get_membership_attack_data(retain_loader, forget_loader, test_loader, model, dataname):
    retain_prob = collect_prob(retain_loader, model, dataname)
    forget_prob = collect_prob(forget_loader, model, dataname)
    test_prob = collect_prob(test_loader, model, dataname)
...
# https://arxiv.org/abs/2205.08096
def get_membership_attack_prob(retain_loader, forget_loader, test_loader, model, dataname='Cifar15'):
    X_f, Y_f, X_r, Y_r = get_membership_attack_data(retain_loader, forget_loader, test_loader, model, dataname)
