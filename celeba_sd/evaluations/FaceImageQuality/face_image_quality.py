...
sys.path.append("./FaceImageQuality/")

from sklearn.preprocessing import normalize
from sklearn.metrics.pairwise import euclidean_distances

# Insightface imports
from FaceImageQuality.insightface.src import mtcnn_detector
from FaceImageQuality.insightface.src import face_preprocess
...
class SER_FIQ:
    ...
    def __init__(self,
        ...
        self.insightface = gluon.nn.SymbolBlock.imports(
                                    "./evaluations/FaceImageQuality/insightface/model-r100-ii/model-symbol.json",
                                    ['data'],
                                    "./evaluations/FaceImageQuality/insightface/model-r100-ii/model-0000.params",
                                    ctx=self.device
                           )
        ...
        self.detector = mtcnn_detector.MtcnnDetector(model_folder="./evaluations/FaceImageQuality/insightface/model_r100-ii/", #mtcnn-model
                                                    ctx=self.device, 
                                                    num_worker=1, 
