...
__all__ = ['resnet101', 'resnet152', 'resnet200',
           'resnet110', 'resnet164',
           ...
           'wide_resnet28_10', 'wide_resnet40_10']#'resnet18', 'resnet34', 'resnet50',
...
class ResNet(nn.Module):
    ...
    def __init__(self, arch, block, layers, num_classes=1000, zero_init_residual=True,
                 ...
                 norm_layer=None, dataset='imagenet', split_factor=1, output_stride=8, dropout_p=None):
...
def wide_resnet28_10(pretrained=False, progress=True, **kwargs):
    ...
    return _resnet('wide_resnet28_10', BasicBlock, [4, 4, 4, 4],
                   pretrained, progress, num_classes=10, norm_layer=norm.norm('batch'),
