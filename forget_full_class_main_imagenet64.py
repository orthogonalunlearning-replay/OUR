...
import forget_full_class_strategies_gtsrb
from pretrain_model_imagenet import build_retain_sets
from utils import *
import datasets
import models
import config
...
parser.add_argument("-b", type=int, default=16, help="batch size for dataloader, 64")
...
(retain_train, retain_valid) = build_retain_sets_in_unlearning_gtsrb(classwise_train, classwise_test, args.classes,
...
# ood_valid_dl = []
# ood_train_dl = []
all_classes=range(args.classes)
...
# Time the method
import time
print("forget_full_class_main_imagenet64")
# executes the method passed via args
(d_t, d_f, d_r, mia), time_elapsed = getattr(forget_full_class_strategies_gtsrb, args.method)(**kwargs)
