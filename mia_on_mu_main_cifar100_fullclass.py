...
if __name__ == '__main__':
    ...
    classwise_train, classwise_test = get_classwise_ds(trainset, num_classes=100), \
                                      get_classwise_ds(validset, num_classes=100)

    (retain_train, retain_valid) = build_retain_sets_in_unlearning(classwise_train, classwise_test, args.classes,
    ...
    if not osp.exists(checkpoint_path_folder):
        checkpoint_path_folder = os.path.join(config.CHECKPOINT_PATH,
